...
const MODELS = [
{
  ...
  items:[
    ...
    {n:8,  name:"Endoneurium",      accept:["endoneurium"],                              func:"Structural support (wraps individual axons).", roots:"endo- (inner) + neuri- (nerve) + -um (layer)", fkeys:["support","structur","wrap","connective"]},
...
},
{
  ...
  items:[
    ...
    {n:2,  name:"Hypothalamus",    accept:["hypothalamus"],                 func:"Controls hunger and thirst (homeostasis).", roots:"hypo- (under) + thalamus (inner chamber)", fkeys:["hunger","thirst","homeostasis","temperature","hormone"]},
    ...
    {n:6,  name:"Corpus callosum", accept:["corpus callosum"],              func:"Integrates the two hemispheres (connects them).", roots:"corpus (body) + callosum (tough/hard)", fkeys:["hemisphere","connect","integrat","bridge","communicat"]},
    ...
    {n:9,  name:"Medulla oblongata",accept:["medulla","medulla oblongata"], func:"Controls heart rate and blood pressure.", roots:"medulla (core/marrow) + oblongata (elongated)", fkeys:["heart","blood pressure","bp","cardiac","respir","autonomic"]},
    {n:10, name:"Cerebellum",      accept:["cerebellum"],                   func:"Coordination and balance.", roots:"cerebellum (Latin: 'little brain')", fkeys:["coordinat","balance","motor","posture"]},
...
},
{
  ...
  items:[
    {n:1,  name:"Sclera",          accept:["sclera"],                       func:"Protects the eye (tough outer layer).", roots:"scler- (hard)", fkeys:["protect","outer","white","support","shape"]},
    {n:2,  name:"Cornea",          accept:["cornea"],                       func:"Bends (refracts) light.", fkeys:["bend","refract","light","focus"]},
    {n:3,  name:"Choroid",         accept:["choroid"],                      func:"Nourishes the retina (blood supply).", roots:"chorio- (membrane) + -oid (like)", fkeys:["nourish","blood","supply","retina","nutrient"]},
    ...
    {n:10, name:"Vitreous body",   accept:["vitreous body","vitreous humor","vitreous humour"], func:"Supports the retina (holds the eye's shape).", roots:"vitre- (glassy) + -ous", fkeys:["support","retina","shape","gel"]},
    ...
    {n:12, name:"Macula lutea",    accept:["macula lutea","macula"],        func:"Sharp central vision — highest concentration of cones.", roots:"macula (spot) + lutea (yellow)", fkeys:["sharp","central","cone","acuity","detail"]},
...
},
{
  ...
  items:[
    ...
    {n:3,  name:"Tympanic membrane", accept:["tympanic membrane","eardrum"], func:"Vibrates when sound hits it.", roots:"tympanum (drum) + -ic", fkeys:["vibrat","sound","eardrum"]},
    ...
    {n:5,  name:"Malleus",         accept:["malleus","hammer"],             func:"Passes sound vibrations.", roots:"malleus (Latin: hammer)", fkeys:["vibrat","pass","sound","ossicle"]},
    {n:6,  name:"Incus",           accept:["incus","anvil"],                func:"Passes vibrations to the stapes.", roots:"incus (Latin: anvil)", fkeys:["vibrat","stapes","pass","ossicle"]},
    {n:7,  name:"Stapes",          accept:["stapes","stirrup"],             func:"Sends vibrations to the inner ear.", roots:"stapes (Latin: stirrup)", fkeys:["vibrat","inner","oval window","ossicle"]},
    ...
    {n:10, name:"Semicircular canals", accept:["semicircular canals","semicircular canal"], func:"Detects head movement.", roots:"semi- (half) + circular", fkeys:["head","movement","rotation","balance","motion"]},
    {n:11, name:"Cochlea",         accept:["cochlea"],                      func:"Changes sound into nerve signals.", roots:"cochlea (snail shell)", fkeys:["sound","nerve","signal","convert","hearing"]},
...
},
{
  ...
  items:[
    {n:1,  name:"Scala vestibuli", accept:["scala vestibuli","scala vestibule"], func:"Carries sound through the cochlea.", roots:"scala (staircase) + vestibuli (of the entrance)", fkeys:["carry","sound","through","cochlea"]},
    {n:2,  name:"Scala tympani",   accept:["scala tympani"],                func:"Carries sound out of the cochlea.", roots:"scala (staircase) + tympani (of the drum)", fkeys:["carry","sound","out","cochlea"]},
    ...
    {n:5,  name:"Tectorial membrane", accept:["tectorial membrane"],        func:"Helps bend the hair cells.", roots:"tectorium (a roof/cover) + -al", fkeys:["bend","hair cell","stimulat"]},
    {n:6,  name:"Basilar membrane",accept:["basilar membrane"],             func:"Supports the hair cells and moves with sound.", roots:"basi- (base) + -lar", fkeys:["support","hair cell","move","vibrat","sound"]},
