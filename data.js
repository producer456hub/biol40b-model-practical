...
const MODELS = [
{
  ...
  items:[
    ...
    {n:3,  name:"Nucleolus",        accept:["nucleolus"],                                func:"Produces ribosomes.", fkeys:["ribosom","rrna"], exam:false},
    ...
    {n:8,  name:"Endoneurium",      accept:["endoneurium"],                              func:"Structural support (wraps individual axons).", fkeys:["support","structur","wrap","connective"], exam:false},
...
},
{
  ...
  items:[
    ...
    {n:11, name:"4th ventricle",   accept:["4th ventricle","fourth ventricle"], func:"Circulation of CSF (cerebrospinal fluid).", fkeys:["csf","cerebrospinal","fluid","circulat"], exam:false},
...
},
{
  ...
  items:[
    ...
    {n:7,  name:"Anterior chamber",accept:["anterior chamber"],             func:"Contains aqueous humor.", fkeys:["aqueous","humor","fluid"], exam:false},
    {n:8,  name:"Posterior chamber",accept:["posterior chamber"],           func:"Contains aqueous humor.", fkeys:["aqueous","humor","fluid"], exam:false},
    {n:9,  name:"Posterior cavity", accept:["posterior cavity","vitreous chamber"], func:"Filled with vitreous body.", fkeys:["vitreous","fluid","gel"], exam:false},
